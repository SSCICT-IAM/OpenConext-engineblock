...
return array(
    ...
    'idp_selection_subheader'   => 'Login via your organisation',
    'search'                    => 'Search for an organisation...',
    'idp_selection_desc'        => 'Select an organisation to login to <i>%s</i>',
    'our_suggestion'            => 'Previously chosen:',
    'idps_with_access'          => 'Organisation with access',
    'no_access'                 => 'No access',
    'no_access_more_info'       => 'No access. &raquo;',
    'no_results'                => 'Your search did not return any results.',
    'error_header'              => 'Error',
    'log_in_to'                 => 'Select an organisation to login to the service:',
    'press_enter_to_select'     => 'Press enter to select',
    'loading_idps'              => 'Loading organisations...',
    'edit'                      => 'Edit List',
    'done'                      => 'Done',
    'remove'                    => 'Remove',
    'request_access'            => 'Request access',
    'no_idp_results'            => 'Your search did not return any results.',
    'no_idp_results_request_access' => 'Can\'t find your organisation? &nbsp;<a href="#no-access" class="noaccess">Request access</a>&nbsp;or try tweaking your search.',
    ...
    'serviceprovider_link'  => '<a href="https://www.surfconext.nl/" target="_blank">OpenConext</a>',
    ...
    'footer'                => '<a href="https://www.surfconext.nl/" target="_blank">OpenConext</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="https://wiki.surfnet.nl/display/conextsupport/Terms+of+Service+%28EN%29">Terms of Service</a>',
    ...
    <p>For more detailed information, please visit <a href="https://support.surfconext.nl/">the OpenConext support page</a>.</p>',

    'close_question'        =>      'Close',

    // Help questions
    // general help questions
    'question_surfconext'               =>      'What is OpenConext?',
    'answer_surfconext'                 =>      '<p>OpenConext is a next generation collaboration infrastructure that creates new opportunities to collaborate online based on a combination of federation technology, group management, concepts from social networking and applications from different providers. OpenConext allows you to access online services with the username and password issued to you by your own organisation.</p>',
    'question_log_in'                   =>      'How do you login via OpenConext?',
    'answer_log_in'                     =>      '<ul>
                            <li>Click on your organisation in this screen.</li>
                            <li>You will then be redirected to the log-in page of your organisation where you can log in.</li>
                            <li>Your organisation will notify OpenConext that you have logged in successfully.</li>
                            <li>You will be taken to the service for which you have logged in. You can then start using that service.</li>
                        </ul>',
    'question_security'                 =>      'Is OpenConext secure?',
    'answer_security'                   =>      '<p>Your organisation and SSC-ICT believe that user privacy is extremely important.<br />
<br />
Personal details are only provided to a service provider if these details are needed to use the service. Contractual agreements between your organisation, SSC-ICT and the service provider guarantee that your personal details will be handled and processed with care.<br />
<br />
If you have any questions about your privacy and the policy applied, please contact the administrators at <a href="mailto:FederatieveServices@minbzk.nl">FederatieveServices@minbzk.nl</a>.
</p>',
    ...
    'answer_screen'                     =>      '<p>You can log in to this service with your organisation account. In this screen, you select the organisation you are affiliated with.</p>',
    'question_institution_not_listed'   =>      'My organisation is not listed. What should I do?',
    'answer_institution_not_listed'     =>      '<p>If your organisation is not listed, then it is either not linked to OpenConext or your organisation may not allow access to this particular service. Go back to the page for the service. In some cases, there will be alternative ways of logging in.</p>',
    'question_institution_no_access'    =>      'My organisation does not allow access to the service. What should I do?',
    'answer_institution_no_access'      =>      '<p>It is possible that your organisation is connected to OpenConext but has not (or not yet) made any arrangements with the service provider about the use of the service. We will forward your request to your organisation. Based on your request your organisation may consider to add this service to its service portfolio.</p>',
    'question_asked_institution_access'  =>      'I have asked my organisation for access but I still cannot get access. Why not?',
    'answer_asked_institution_access'    =>      '<p>Apparently, your organisation has not arranged a license yet or, access to this service is not on the roadmap of your organisation. Such decisions are beyond the scope and control of SSC-ICT.</p>',
    'question_cannot_select'            =>      'In my browser I cannot select my organisation. What should I do?',
    'answer_cannot_select'              =>      '<p>The dialog box to select your organisation can be used in most popular browsers, including Internet Explorer, Firefox, Chrome, and Safari. Other browsers may not be supported. Your browser must support the use of cookies and JavaScript.</p>',

    //Form
    'sorry'                 => 'Unfortunately,',
    'form_description'      => 'does not have access to this service. What can you do?</h2>
            <p>If you want to access this service, please fill out the form below. We will then forward your request to the person responsible for the services portfolio management at your organisation.</p>',
    'request_access_instructions' => '<h2>Unfortunately, you do not have access to the service you are looking for.
                                ...
                                <p>If you want to access this service, please fill out the form below.
                                   ...
                                   portfolio management at your organisation.</p>',
    'name'                  => 'Name',
    'name_error'            => 'Enter your name',
    'email'                 => 'E-mail',
    'email_error'           => 'Enter your (correct) e-mail address',
    'institution'           => 'Organisation',
    'institution_error'     => 'Enter an organisation',
    'comment'               => 'Comment',
    ...
    'send_confirm_desc'     => '<p>Your request has been forwarded to your organisation. Further settlement and decisions on the availability of this service will be taken by the ICT staff of your organisation.</p>

    <p>SSC-ICT has forwarded your request, but the decision and planning to make this service available depends on the ICT policy of your organisation.</p>

    <p>If you have any questions about your request, please contact <a href="mailto:FederatieveServices@minbzk.nl">FederatieveServices@minbzk.nl</a></p>',
    ...
    'consent_sp_idp_info'               => 'In order to log in to <strong class="service-provider">%1$s</strong> using your organisation account, <strong class="identity-provider">%2$s</strong> uses OpenConext. This service is only accessible through OpenConext if <strong class="identity-provider">%2$s</strong> shares certain information with this service. For this, your permission is required. The service needs the following information:',
...
The service you\'re trying to reach (&lsquo;Service Provider&rsquo;) is not accessible through OpenConext.<br /><br />

Visit <a href="https://wiki.surfnet.nl/x/m69WAw" target="_blank">the OpenConext support pages</a> for more support, if you think you should have access to this service.
        <br /><br />
    </p>',
...
Visit <a href="https://wiki.surfnet.nl/x/jq9WAw" target="_blank">the OpenConext supportpages</a> for more extensive support on this error.
        <br /><br />
    </p>',
    'error_dissimilar_workflow_state'       => 'Error - Dissimilar workflow states',
    'error_dissimilar_workflow_state_desc'  => '<p>
The application you came from (your &lsquo;Service Provider&rsquo;) is not available on the OpenConext infrastructure yet.
...
<br /><br />
    ...
    'error_authorization_policy_violation_desc'       => '<p>
        You have successfully logged in at your organisation, but unfortunately you cannot use this service (the &lsquo;Service Provider&rsquo;) because you have no access. Your organisation limits access to this service with an <i>authorization policy</i>. Please contact your organisation\'s helpdesk if you think you should be allowed access to this service.
    </p>',
    'error_authorization_policy_violation_name'       => 'Authorization policy message',
    'error_authorization_policy_violation_info'       => 'Message from your organisation: ',
    ...
    'error_unknown_preselected_idp' => 'Error - No connection between organisation and service',
    'error_unknown_preselected_idp_desc' => '<p>
        The organisation that you want to use to login to this service did not activate access to this service. This means you are unable to use this service through OpenConext. Please contact your organisation\'s helpdesk to request access to this service. State what service it is about (the &lsquo;Service Provider&rsquo;) and why you need access.
    </p>',
    'error_unknown_service_provider'          => 'Error - Cannot provide metadata for EntityID \'%s\'',
    'error_unknown_service_provider_desc'     => '<p>
Your requested service couldn\'t be found. Visit <a href="https://wiki.surfnet.nl/x/k69WAw" target="_blank">the OpenConext supportpages</a> for more extensive support on this error.
    </p>',

    'error_unknown_issuer'          => 'Error - Unknown service',
    'error_unknown_issuer_desc'     => '<p>
        The service you are trying to log in to is unknown to OpenConext. Possibly your organisation has never enabled access to this service. Please contact the helpdesk of your organisation and provide them with the following information:
    </p>',
    'error_generic'                     => 'Error - An error occurred',
    'error_generic_desc'                => '<p>
Your log-in has failed and we don\'t know exactly why. Try again first, and if that doesn\'t work visit <a href="https://wiki.surfnet.nl/x/iq9WAw" target="_blank">the OpenConext supportpages</a> for more support with this error. On that page you can also find how to contact us if the error persists.
    </p>',
    'error_missing_required_fields'     => 'Error - Missing required fields',
    'error_missing_required_fields_desc'=> '<p>
        You can not use this application because your organisation is not providing the needed information.
    </p>
    <p>
        Please contact your organisation with the information stated below.
    </p>
    <p>
        Login failed because the organisation\'s identity provider did not provide OpenConext with one or more of the following required attribute(s):
        <ul>
            <li>UID</li>
    ...
    'error_group_oauth_desc'       => '<p>
        ...
        <p>Please contact the administrators at <a href="mailto:FederatieveServices@minbzk.nl">FederatieveServices@minbzk.nl</a>.
       </p>',
    'error_received_error_status_code'     => 'Error - Identity Provider error',
    'error_received_error_status_code_desc'=> '<p>
Your organisation has denied you access to this service. You will have to contact your own (IT-)servicedesk to see if this can be fixed.
    </p>',
    ...
    'error_stuck_in_authentication_loop' => 'Error - You got stuck in a loop',
    'error_stuck_in_authentication_loop_desc' => '<p>
        You\'ve successfully authenticated at your organisation but the service you are trying to access sends you back to OpenConext again. Because you are already logged in, OpenConext then forwards you back to the service, which results in an infinite loop. Likely, this is caused by an error at the Service Provider. Visit <a href="https://support.surfconext.nl" target="_blank">the OpenConext support pages</a> for more extensive support on this error.
    </p>',
    ...
    'error_attribute_validator_not_in_definitions'  => '%1$s is not known in the OpenConext schema',
    ...
    'idp_debugging_mail_explain' => 'When requested by the administrators,
                                        use the "Mail to SSC-ICT" button below
                                        to mail the information in this screen.',
    'idp_debugging_mail_button' => 'Mail to SSC-ICT',
